...
const OrderTable = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (text, record) =>
        _.get(record, "shippingAddress.fullName", "N/A"), // Sử dụng lodash.get
    },
    {
      title: "Phone",
    ...
    },
    {
      ...
      render: (status, record) => {
        const handleChange = async (value) => {
          try {
            await updateOrderStatus(record._id, value);
  ...
  return (
    <>
      <div style={{ display: "flex", justifyContent: "space-between" }}>
        <ButtonComponent
          onClick={() =>
            exportFileExcel(listOrders, "Products", "products-table.xlsx")
          }
          text={"Export .xlsx"}
          icon={<ExportOutlined />}
